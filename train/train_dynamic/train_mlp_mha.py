...
from utils.eval_flag import eval_mat, eval_mat_fined, eval_mat_combined, eval_mat_dynamic, eval_mask
...
def train(args):
    ...
    # model_path = '/home-new/nus-zwb/reuse/code/train/train_mat/logs_weight/mat_base_20_40_12108_cifar1001e-05/Feb19_05-50-01/weight/vit.pth'
    ...
    for epoch in range(args.epochs):
        ...
        if epoch % 2 == 0:
            ...
            for index, f in enumerate(flags_list):
                ...
                eval_mask(model, valDataLoader, criterion, epoch, optimizer, args, flag=f, sub_dim=sub_dim,
