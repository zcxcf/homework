...
import wandb
from models.final.model_base_v2 import MatVisionTransformer, ModifiedBlock
...
def train(args):
    ...
    model_path = '/home-new/nus-zwb/reuse/code/train/train_mat/logs_weight/flextron_matformer_depth_cifar1001e-05/Feb21_13-19-34/weight/matformer.pth'
