    ...
    for epoch in range(args.epochs):
        ...
        for batch_idx, (img, label) in enumerate(trainDataLoader):
            ...
            for i in range(accmulated_step):
                ...
                if reward > sum_reward:
                    loss_reward = reward-sum_reward
                    sum_reward = sum_reward * 0.99 + reward * 0.01
                else:
                    loss_reward = 0
