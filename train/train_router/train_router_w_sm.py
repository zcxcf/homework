...
def train(args):
    ...
    sm.to(args.device)
    sm.eval()
    check_point_path = '/home/ssd7T/zc_reuse/iccv/router_logs_weight/smnone_cifar100/Feb11_19-23-19/weight/sm.pth'
    checkpoint = torch.load(check_point_path, map_location=args.device)
    sm.load_state_dict(checkpoint, strict=True)
    ...
    for epoch in range(args.epochs):
        ...
        for i in range(accmulated_step):
            ...
            sub_dim, depth_list, mlp_ratio_list, mha_head_list, loss = sm(probs)
