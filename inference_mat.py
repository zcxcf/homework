...
if __name__ == '__main__':
    ...
    model_path = '/home-new/nus-zwb/reuse/code/train/train_mat/logs_weight/mat_flextron_stage_cifar1001e-05/Feb22_13-45-31/weight/matformer.pth'
    ...
    mlp_ratio = 0.5
    # mlp_ratio = [2, 2, 2, 2, 2, 2, 4, 4, 4, 4, 4, 4]
    # mlp_ratio = 6*[2]+6*[4]
    # mha_head = 5
    # mha_head = 12*[5]
    mha_head = 8
